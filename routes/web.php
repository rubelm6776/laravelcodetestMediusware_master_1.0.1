...
//Route::get('/search', 'PagesController@searchData')->name('searchData');
...
Route::get('/search_post_data', 'PagesController@searchDataHistory')->name('searchDataHistory');
Route::get('/history', 'PagesController@history')->name('history');
Route::get('/codetest', 'CodetestController@codetest')->name('codetest');
