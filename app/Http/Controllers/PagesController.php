...
//        $data = BufferPosting::paginate(15);
    ...
    public function searchDataHistory(Request $request)
    {
...
//
//
//        $data_search = BufferPosting::with('group', 'account');
//        if (!empty($request->keywords)){
//            $data_search->where('post_text', 'like', "%$request->keywords%");
//        }
//
//        if ($request->date_search !='null'){
//            $data_search->Where('created_at', 'like', "%$date%");
//
//        }
////        if ($request->group_filter!='null') {
////
////            $data_search->whereHas('group', function ($query) use ($request) {
////                $query->where('type', $request->group_filter);
////            });
////                }
//        $data_search->paginate(15);
//
